...
let estiloLinAmarilla = new M.style.Line({
    fill: {
       color: 'yellow',
       width: 2
    }
...
var layercdau_viales = new M.layer.GeoJSON(
	{name: "Viales CDAU", 
	source: geo

});

layercdau_viales.setStyle(estiloLinAmarilla );
mapajs.addLayers(layercdau_viales);
